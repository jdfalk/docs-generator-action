...
- This is a composite GitHub Action that embeds Python logic directly in
  action.yml.
- All changes to documentation generation logic should be made in the embedded
...
This repository provides a composite GitHub Action that automatically generates
and maintains project documentation including API docs, workflow catalogs, and
search indexes.
